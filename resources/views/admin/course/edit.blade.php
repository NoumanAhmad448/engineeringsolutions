    ...
    <div class="card-body">
        <form method="POST" enctype="multipart/form-data"
            ...
            <div class="form-group">
                ...
                <input type="text" name="time_selection"
                       class="form-control"
            ...
            <div class="form-group">
                ...
                <textarea name="learnable_skill"
                          class="form-control">{{ $course->learnable_skill }}</textarea>
            </div>

            <div class="form-group">
                <label>Course Requirement</label>
                <textarea name="course_requirement"
                          class="form-control">{{ $course->course_requirement }}</textarea>
            </div>

            <div class="form-group">
                <label>Targeting Student</label>
                <textarea name="targeting_student"
                          class="form-control">{{ $course->targeting_student }}</textarea>
            </div>
            <div class="form-group">
